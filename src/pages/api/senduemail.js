...
const handler = async (req, res) => {
  ...
  const info = await transporter.sendMail({
    ...
    subject: `Booking Conformation for ${req.body.type}`, // Subject line
    text: "Booking Conformation", // plain text body
    html: `
        <body
class="clean-body"
style="
                    ...
                    >
                      ...
                      >
                        <span style="font-size: 30px"
                          >Booking confirmation for ${req.body.type}</span
                        >
                      </p>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span style="color: #fb3c2d"
                          ><strong>${req.body.orderid}</strong></span
                        >
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <p
                        ...
                        "
                      >
                        <span style="font-size: 16px">₹ ${req.body.price}</span>
                      </p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                    ...
                    >
                      ...
                      >
                        <span style="font-size: 22px"
                          ><strong
                            ><span style="">Total ₹ ${req.body.price}</span></strong
                          ></span
                        >
                      </p>
                    </div>
            ...
            >
              <div class="col_cont" style="width: 100% !important">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <p
                        ...
                        "
                      >
                        You can find more amazing plans on our website. 
                      </p>
                      <p
                      style="
                        font-size: 14px;
                      ...
                      "
                    >
                    Join us and enjoy the best travel rental app in your city.
                    </p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                  ...
                  >
                   <a
                      href="${process.env.NEXT_PUBLIC_HOST}/components/Plans"
                      style="
